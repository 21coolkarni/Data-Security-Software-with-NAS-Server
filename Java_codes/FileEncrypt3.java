...
class FileEncrypt3
{
    ...
    public void FileV() throws Exception {
        try {
            final JFileChooser fileChooser = new JFileChooser();
            final FileNameExtensionFilter filter = new FileNameExtensionFilter("(.mp4)", new String[] { "mp4", "Video" });
            ...
            if (fileChooser.showOpenDialog(null) == 0) {
                ...
                final FileOutputStream outFile = new FileOutputStream("HashVideo.des");
