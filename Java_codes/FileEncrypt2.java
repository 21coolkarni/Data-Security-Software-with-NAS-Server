...
class FileEncrypt2
{
    ...
    public void FileA() throws Exception {
        try {
            ...
            final FileNameExtensionFilter filter = new FileNameExtensionFilter("(.mp3)", new String[] { "mp3", "Audio" });
            ...
            if (fileChooser.showOpenDialog(null) == 0) {
                ...
                final FileOutputStream outFile = new FileOutputStream("HashAudio.des");
