...
class FileEncrypt1
{
    ...
    public void FileJ() throws Exception {
        try {
            final JFileChooser fileChooser = new JFileChooser();
            final FileNameExtensionFilter filter = new FileNameExtensionFilter(".jpg", new String[] { "jpg", "image" });
            ...
            if (fileChooser.showOpenDialog(null) == 0) {
                ...
                final FileOutputStream outFile = new FileOutputStream("HashImage.des");
